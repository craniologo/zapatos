<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <br><br>
      <form class="form-horizontal" method="post" enctype="multipart/form-data" name="product_update_barcode" id="product_update_barcode" action="index.php?action=product_update_barcode" role="form">
