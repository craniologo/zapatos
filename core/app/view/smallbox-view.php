        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3>S/ <?php echo number_format($ins->s-$outs->s,2,".",",");?></h3>
          	...
          	<table class="table table-bordered table-hover datatable ">
                ...
                <td><?php if($op->kind==1){echo "Entrada";}else{ echo "Salida"; }?></td>    
              	...
              	<td style="width:160px;">
              		...
              		<a href="./?action=operations&opt=del&id=<?php echo $op->id;?>&k=1" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Eliminar</a></td>
            	</tr>
          	<?php endforeach;?>
          	</table>
          </div>
          ...
          <form method="post" action="./?action=operations&opt=add">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control"  placeholder="Monto S/" name="amount">
              </div>
            </div>
