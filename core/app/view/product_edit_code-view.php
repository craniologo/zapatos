<section class="content">
  <?php $product = ProductData::getByBarcode($_POST["barcode"]); ?>
  <div class="row">
    <div class="col-md-12">
      ...
      <br><br>
      <form class="form-horizontal" method="post" enctype="multipart/form-data" name="product_update_barcode" id="product_update" action="index.php?action=product_update_barcode" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input type="text" name="barcode" id="barcode" class="form-control" id="barcode" value="<?php echo $product->barcode; ?>" placeholder="Código de Barras" readonly>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         <label for="inputEmail1" class="col-lg-2 control-label">Serie*</label>
          ...
          <div class="col-md-3">
            <input type="text" name="size_id" id="size_id" class="form-control" id="size_id" value="Tallas de la serie" placeholder="Talla" readonly>
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail1" class="col-lg-2 control-label">Mínimo*</label>
          <div class="col-md-3">
            <input type="text" name="stock_min" id="stock_min" class="form-control" id="stock_min" value="No modificable" placeholder="Stock mínimo del producto" readonly="">
          </div>
