    ...
    <?php $user = PersonData::getById($_GET["id"]);?>
      ...
      <form class="form-horizontal" method="post" id="addproduct" action="index.php?action=client_update" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input type="text" name="address" value="<?php echo $user->address;?>" class="form-control" required id="username" placeholder="Direccion del cliente">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input type="text" name="phone"  value="<?php echo $user->phone;?>"  class="form-control" id="inputEmail1" placeholder="Número de teléfono">
          </div>
        </div>
        <div class="form-group">
