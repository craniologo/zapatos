...
$table1->addCell(2000)->addText("S/ ".number_format($client->total*($client->discount/100),2,".",","));
$table1->addCell(2000)->addText("S/ ".number_format($client->total-($client->total*($client->discount/100) ),2,".",",") );
$table1->addCell(2500)->addText($client->created_at);
$total+=$client->total-($client->total*($client->discount/100) );
}

$word->addTableStyle('table1', $styleTable,$styleFirstRow);
$section1->addText("Total: S/ ".number_format($total,2,".",","),array("size"=>22,"bold"=>true,"align"=>"right"));
/// datos bancarios
