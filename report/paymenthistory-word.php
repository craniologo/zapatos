...
$table1->addCell(2000)->addText("S/ ". number_format(PaymentData::sumByClientId($client->val)->total,2,".",","));
$table1->addCell(2000)->addText("S/ ". number_format(PaymentData::sumByClientId($total)->total,2,".",","));
